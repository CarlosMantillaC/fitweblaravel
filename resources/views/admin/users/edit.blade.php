    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-full md:w-64 bg-gray-800 text-gray-100 shadow-lg md:block hidden md:relative p-4 lg:p-8">
            ...
            <nav class="mt-6 space-y-2">
                <a href="/admin/dashboard" class="block py-2.5 px-4 hover:bg-gray-700 rounded">Inicio</a>
                <a href="{{ route(class_basename($user) === 'Admin' ? 'admin.users' : 'receptionist.users') }}"
            ...
            <div class="max-w-6xl mx-auto bg-gray-800 rounded-lg shadow-lg p-10">
                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="flex justify-end space-x-3 mt-8">
                        ...
                        <button type="submit"
                            class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded">Actualizar</button>
                    </div>
                </form>
            </div>
        </div>
