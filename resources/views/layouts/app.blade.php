            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav class="hidden md:block">
                    <ul class="flex space-x-8">
                        ...
                        <li><a href="sobre-nosotros" class="text-white hover:text-[#f36100]  transition">Nosotros</a></li>
                ...
                <div id="mobile-sidebar" class="lg:hidden fixed inset-0 z-40 closed">
                    ...
                    <div
                        class="relative flex-1 flex flex-col w-72 max-w-xs bg-primary h-full border-r border-primary">
                        ...
                        <div class="p-6 border-b border-gray-700">
                            <h1 class="text-2xl font-bold text-tertiary">FitWeb</h1>
                        </div>
