...
<section class="py-30 bg-primary text-white">
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap justify-center text-center mb-12">
            ...
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/6">
                <div>
                    <h4 class="font-semibold text-lg mb-4 text-[#f36100]">Soporte</h4>
                    <ul class="space-y-2">
        ...
        <div class="text-center pt-12">
            <p class="text-sm">&copy;
                ...
                </script> Todos los derechos reservados | Desarrollado por CadiTech
            </p>
        </div>
    </div>
</section>
