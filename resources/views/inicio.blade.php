...
@section('content')
<!-- Hero Section -->
<section class="relative h-200 flex items-center bg-cover bg-center bg-blend-overlay " style="background-image: url('img/hero/hero8.png');" data-aos="fade-up" data-aos-duration="1500">
        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="lg:w-1/2 text-white flex justify-center items-center">
                <div class="mt-20 space-y-6 text-center animate__animated animate__fadeIn animate__delay-0.5s">
                    <span class="text-2xl font-semibold text-white block mb-6 opacity-80 animate__animated animate__fadeIn animate__delay-1s">Transforma tu gimnasio hoy mismo</span>
                    <h1 class="text-5xl md:text-7xl font-extrabold leading-tight text-white animate__animated animate__fadeIn animate__delay-1s">
                        <span class="text-tertiary">FitWeb</span> - Tu Socio Digital
                    </h1>

                    <!-- Botón interactivo -->
                    <a href="contactanos"
                        class="inline-block bg-gradient-to-r from-[#f36100] to-[#ff6500] hover:bg-gradient-to-r hover:from-[#ff6500] hover:to-[#f3a00b] text-white font-extrabold py-6 px-12 rounded-full transform transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-[#f36100] mt-8 text-lg md:text-xl"
...
<section class="py-20 bg-black" data-aos="fade-up" data-aos-duration="1500">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <span class="text-orange-500 font-semibold uppercase">Problemas que Resolvemos</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="bg-[#151515] p-8 rounded-xl shadow-2xl text-center transform transition-all duration-500 
                hover:scale-105 hover:shadow-xl hover:shadow-orange-500/50 
                ...
                <div class="text-orange-500 text-5xl mb-6 group-hover:-translate-y-2 transition-transform duration-500">
                    <i class="fas fa-robot"></i>
                </div>
                <h4 class="text-2xl font-extrabold mb-4 text-white group-hover:text-orange-500">
                    Automatización Integral
                </h4>
                <p class="text-gray-400 text-lg font-light">Elimina procesos manuales en reservas, pagos y control de acceso con nuestra plataforma todo-en-uno</p>
            </div>
            ...
            <div class="bg-[#151515] p-8 rounded-xl shadow-2xl text-center transform transition-all duration-500 
                ...
                <p class="text-gray-400 text-lg font-light">Dashboard ejecutivo con métricas clave para una gestión basada en datos reales</p>
            </div>
            ...
            <div class="bg-[#151515] p-8 rounded-xl shadow-2xl text-center transform transition-all duration-500 
                ...
                <p class="text-gray-400 text-lg font-light">Solución adaptable para gimnasios pequeños y medianos sin costos adicionales por crecimiento</p>
            </div>
...
<!-- Benefits Section -->
<section class="py-14 bg-cover bg-center" style="background-image: url('img/classes/gym-background.jpg')" data-aos="fade-up" data-aos-duration="1500">
    <div class="py-12">
        <div class="container mx-auto px-4">
            <div class="text-center text-white mb-24">
                <h2 class="text-3xl lg:text-5xl font-bold text-[#f36100]">Beneficios para Administradores</h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Benefit 1 -->
                <div class="text-center text-white" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                ...
                <!-- Benefit 2 -->
                <div class="text-center text-white" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                    <div class="text-orange-500 text-4xl mb-4">
                ...
                <!-- Benefit 3 -->
                <div class="text-center text-white" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
                    <div class="text-orange-500 text-4xl mb-4">
                        <i class="fas fa-chart-line"></i>
                    </div>
...
<section class="py-20 bg-[#0A0A0A]" data-aos="fade-up" data-aos-duration="1500">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                ...
                <p class="text-white font-light">Incluye todas las funcionalidades para administradores, sin límite de usuarios
                    o transacciones.</p>
            </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
                ...
                <p class="text-white font-light">Asistencia técnica 24/7, capacitación inicial y actualizaciones gratuitas.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <!-- Gallery Section -->
<div class="container mx-auto px-4 py-1" data-aos="fade-up">
    <div class="text-center mb-16" data-aos="fade-up" data-aos-delay="100">
        <h2 class="text-3xl md:text-4xl font-bold mt-2 text-white mb-4" data-aos="fade-up" data-aos-delay="200">SE PARTE DE LA ERA MODERNA</h2>
        <div class="w-24 h-1 bg-orange-500 mx-auto" data-aos="fade-up" data-aos-delay="300"></div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Imagen grande 1 -->
        <div class="md:col-span-2 relative group overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up" data-aos-delay="400">
        ...
        <!-- Imagen 2 -->
        <div class="relative group overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up" data-aos-delay="500">
        ...
        <!-- Imagen 3 -->
        <div class="relative group overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up" data-aos-delay="600">
        ...
        <!-- Imagen 4 -->
        <div class="relative group overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up" data-aos-delay="700">
        ...
        <!-- Imagen 5 -->
        <div class="relative group overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up" data-aos-delay="800">
        ...
        <!-- Imagen grande 2 -->
        <div class="md:col-span-2 relative group overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up" data-aos-delay="900">
